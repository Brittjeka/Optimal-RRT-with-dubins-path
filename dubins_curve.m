%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reference:
%   Ewing Kang (2020). EwingKang/Dubins-Curve-For-MATLAB 
%   https://www.github.com/EwingKang/Dubins-Curve-For-MATLAB), GitHub. Retrieved March 8, 2020.
%
% The functions 'dubins_core.m' and 'dubins_curve.m', written by Kang (2020), are used in main.m to
% calculate Dubins path between q_new and q_near(est). In this function, 'dubins_curve.m', some adjustments are made.   
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
